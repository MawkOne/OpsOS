...
def refresh_reporting_tables(request):
    ...
    try:
        ...
        SELECT 
          ...
          marketing_campaigns_launched, marketing_sends, marketing_opens, marketing_clicks,
          marketing_avg_open_rate, marketing_avg_ctr,
          automation_campaigns_launched, automation_sends, automation_opens, automation_clicks,
          automation_avg_open_rate, automation_avg_ctr,
