"""Pages/CRO Detectors - Auto-generated"""

from .detect_ab_test_opportunities import detect_ab_test_opportunities
from .detect_conversion_funnel_dropoff import detect_conversion_funnel_dropoff
from .detect_cta_performance_analysis import detect_cta_performance_analysis
from .detect_fix_losers import detect_fix_losers
from .detect_high_traffic_low_conversion_pages import detect_high_traffic_low_conversion_pages
from .detect_mobile_desktop_cvr_gap import detect_mobile_desktop_cvr_gap
from .detect_page_cart_abandonment_increase import detect_page_cart_abandonment_increase
from .detect_page_engagement_decay import detect_page_engagement_decay
from .detect_page_error_rate_spike import detect_page_error_rate_spike
from .detect_page_exit_rate_increase import detect_page_exit_rate_increase
...
from .detect_trust_signal_gaps import detect_trust_signal_gaps
from .detect_video_engagement_gap import detect_video_engagement_gap
