...
def detect_schema_markup_gaps(organization_id: str, priority_pages_only: bool = False) -> list:
    """
    ...
    logger.info(f"🔍 Running Schema Markup Gaps detector (priority_pages_only={priority_pages_only})...")
