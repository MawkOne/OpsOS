"""'device_geo_optimization_gaps' Detector"""
...
def detect_device_geo_optimization_gaps(organization_id: str) -> list:
    ...
    try:
        ...
        if opportunities: logger.info(f"✅ Found {len(opportunities)} 'device_geo_optimization_gaps' opportunities")
