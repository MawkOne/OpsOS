...
import { Lightbulb, Target, TrendingUp, Wrench, RefreshCw, Zap, ChevronRight, AlertCircle } from "lucide-react";
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold">✍️ Content Performance</h1>
            </div>
            <p className="text-gray-400">
              4 detectors monitoring content publishing, freshness, and performance
            </p>
          </div>
          <button
            onClick={handleRunScoutAI}
            disabled={running}
            className="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-600 rounded-lg flex items-center gap-2 transition-colors"
          >
            {running ? (
              <>
        ...
        <Card>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            ...
            All Content Performance Opportunities
          </h2>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex flex-col items-end gap-2 ml-4">
                        <div className="text-right">
                          ...
                          <p className="text-lg font-bold text-yellow-400">{opp.potential_impact_score}/10</p>
                        </div>
                        <div className="text-right">
