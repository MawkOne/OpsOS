...
import { Percent, RefreshCw, AlertCircle, ArrowLeft } from "lucide-react";
  ...
  const fetchOpportunities = async () => {
    ...
    try {
      ...
      const filtered = (data.opportunities || []).filter((opp: Opportunity) => 
        opp.title?.toLowerCase().includes('mrr') || opp.title?.toLowerCase().includes('arr') || opp.title?.toLowerCase().includes('refund') || opp.title?.toLowerCase().includes('economics')
      );
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-400">
            Track MRR, ARR, refunds, and unit economics
          </p>
        </div>
