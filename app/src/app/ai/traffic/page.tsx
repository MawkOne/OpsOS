...
import { Network, Target, TrendingUp, Wrench, RefreshCw, Zap, ChevronRight, AlertCircle } from "lucide-react";
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400">
              6 detectors monitoring traffic sources, quality, and channel performance
            </p>
          </div>
          <button
            onClick={handleRunScoutAI}
            disabled={running}
            className="px-4 py-2 bg-cyan-600 hover:bg-cyan-700 disabled:bg-gray-600 rounded-lg flex items-center gap-2 transition-colors"
          >
            {running ? (
              <>
        ...
        <Card>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            ...
            All Traffic & Channels Opportunities
          </h2>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex flex-col items-end gap-2 ml-4">
                        <div className="text-right">
                          ...
                          <p className="text-lg font-bold text-cyan-400">{opp.potential_impact_score}/10</p>
                        </div>
                        <div className="text-right">
