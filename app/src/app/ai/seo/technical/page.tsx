...
import { Wrench, Search, RefreshCw, AlertCircle, ArrowLeft } from "lucide-react";
  ...
  const fetchOpportunities = async () => {
    ...
    try {
      ...
      const filtered = (data.opportunities || []).filter((opp: Opportunity) => 
        (opp.title?.toLowerCase().includes('seo') || opp.title?.toLowerCase().includes('search')) &&
        (opp.title?.toLowerCase().includes('technical') ||
         opp.title?.toLowerCase().includes('health') ||
         opp.title?.toLowerCase().includes('index') ||
         opp.title?.toLowerCase().includes('crawl'))
      );
  ...
  return (
    <AppLayout module="ai">
      <div className="space-y-6">
        <div>
          <Link href="/ai/seo" className="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-4 transition-colors">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Technical SEO Health</h1>
          </div>
          <p className="text-gray-400">
            Monitor indexing, crawl errors, and technical SEO issues
          </p>
        </div>
        ...
        <Card>
          ...
          {loading ? (
            ...
            <div className="text-center py-8 text-gray-400">
              ...
              <p>No technical SEO opportunities found</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex flex-col items-end gap-2 ml-4">
                        <div className="text-right">
                          ...
                          <p className="text-lg font-bold text-orange-400">{opp.potential_impact_score}/10</p>
                        </div>
                        <div className="text-right">
