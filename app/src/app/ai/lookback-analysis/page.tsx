...
export default function LookbackAnalysisPage() {
  ...
  return (
    <AppLayout
      title="Lookback Analysis"
      subtitle="Daily, weekly, and monthly comparisons across all timeframes"
    >
      {/* What This Detects */}
      <Card className="glass mb-8">
        <h2 className="text-xl font-bold mb-4" style={{ color: "var(--foreground)" }}>What Lookback Analysis Finds</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 rounded-full mt-2" style={{ background: "var(--accent)" }}></div>
            <div>
              <p className="font-semibold" style={{ color: "var(--foreground)" }}>Daily Trends</p>
              <p className="text-sm" style={{ color: "var(--foreground-muted)" }}>Day-over-day performance changes</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 rounded-full mt-2" style={{ background: "var(--accent)" }}></div>
            <div>
              <p className="font-semibold" style={{ color: "var(--foreground)" }}>Weekly Patterns</p>
              <p className="text-sm" style={{ color: "var(--foreground-muted)" }}>7-day rolling comparisons</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 rounded-full mt-2" style={{ background: "var(--accent)" }}></div>
            <div>
              <p className="font-semibold" style={{ color: "var(--foreground)" }}>Monthly Aggregates</p>
              <p className="text-sm" style={{ color: "var(--foreground-muted)" }}>30/60/90 day trend analysis</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 rounded-full mt-2" style={{ background: "var(--accent)" }}></div>
            <div>
              <p className="font-semibold" style={{ color: "var(--foreground)" }}>All-Time Context</p>
              <p className="text-sm" style={{ color: "var(--foreground-muted)" }}>Performance vs historical baseline</p>
            </div>
          </div>
        </div>
      </Card>
