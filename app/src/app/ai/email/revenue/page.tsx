...
import { DollarSign, Mail, RefreshCw, AlertCircle, ArrowLeft } from "lucide-react";
...
export default function EmailRevenuePage() {
  ...
  const fetchOpportunities = async () => {
    ...
    try {
      ...
      // Filter for email revenue opportunities
      const filtered = (data.opportunities || []).filter((opp: Opportunity) => 
        (opp.entity_type === 'email' || opp.title?.toLowerCase().includes('email')) &&
        (opp.title?.toLowerCase().includes('revenue') ||
         opp.title?.toLowerCase().includes('attribution') ||
         opp.title?.toLowerCase().includes('conversion'))
      );
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Email Revenue Attribution</h1>
          </div>
          <p className="text-gray-400">
            Track revenue generated by email campaigns and identify attribution gaps
          </p>
        </div>
